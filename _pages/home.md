...
- - Chen, N., Hao, J., **Wang, P.**, & Xu, N. (2026). Quantifying the Relationship Between Street-Level Solar Radiation and Human Perception Using Street View Imagery: Evidence from the Central Urban Area of Shenzhen. Journal of Digital Landscape Architecture, 788-800.
...
<a id="projects"></a>
# PROJECTS
- **Research on Coupling Optimization and Intelligent Decision-Making for Urban Ecological Networks and Public Spaces Enabled by Graph Neural Networks**. Principal Investigator (SEU Innovation Capability Enhancement Plan for Doctoral Students)
